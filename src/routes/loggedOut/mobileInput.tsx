...
export function MobileInput({ navigation }: NativeStackScreenProps<LoggedOutStackParamsList, 'mobileInput'>) {
  ...
  const SocialLoginButton = ({ icon, text, onPress }) => {r
    return (
      ...
      <KeyboardAwareScrollView
        ...
        <View style={{ flex: 1, paddingHorizontal: wp(5) }}>
          ...
          {/* <Pressable onPress={() => setAgeAbove18(!ageAbove18)} hitSlop={20} style={styles.decelerationOuter} >
            <Check />
            <Text style={styles.deceleration} >I certify theat I am above 18 years.</Text>
          </Pressable> */}
          ...
          <View style={styles.btnOuter}>
            <CustomBtn
              ...
              btnStyle={{
                marginTop: hp(2.5),
                width: '100%',
                backgroundColor: (isValidMobile ) ? baseColors.btn_active : baseColors.btn_disable,
              }}
            />
          </View>
