  ...
  const [productList] = useState([
    {
      ...
      category: 'Start tracking your activity and unlocking rewards effortlessly',
    },
  ]);

  const filteredProducts = selectedFilter === 'All' ? productList : productList.filter(product => product.category === selectedFilter);
  ...
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      ...
      <Pressable
        ...
        <Text style={styles.Btn}>Connect your snapup smartwatch</Text>
      </Pressable>
    </View>
  );
  ...
  return (
    <View style={styles.main}>
      ...
      {/* <CustomBtn
        ...
        textStyle={{ color: baseColors.theme, fontFamily: AppFonts.bold, fontWeight: '600' }}
        btnStyle={{ marginVertical: hp(1), backgroundColor: baseColors.white, borderColor: baseColors.theme, borderWidth: 1 }}
        onPress={() => {
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: "center", marginBottom: hp(3) }} >
        <CustomBtn
          ...
          textStyle={{ color: baseColors.theme, fontFamily: AppFonts.bold, fontWeight: '600' }}
          btnStyle={{ marginVertical: hp(1), backgroundColor: 'transparent', borderColor: 'transparent', borderWidth: 1, width: wp(80) }}
