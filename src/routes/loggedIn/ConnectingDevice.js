...
import { disconnectDevice, enableStepAutoUpdate, getBluetoothStatusOnOff, listenToDeviceScans, selectBleDevice } from '../../components/native';
import AppImages from '../../constants/AppImages';
import { baseColors } from '../../constants/colors';
import AppFonts from '../../constants/fonts';
import { setLoader } from '../../redux/Reducers/tempData';
import { setAuthRedux, setDeviceAddress, setToken } from '../../redux/Reducers/userData';
import { createRef, useEffect, useState } from 'react';
import { Image, Pressable, StyleSheet, Text, View, Linking, Platform, Modal } from 'react-native';
        ...
        <View style={styles.subCon}>
          ...
          {bluetoothStatus && (
            <View style={styles.progressContainer}>
              <Progress.Bar progress={progress} width={wp(90)} height={hp(0.5)} color={baseColors.themeLight} borderRadius={5} />
              <View style={styles.Connncted_Con}>
                {isConnected ? (
                  <>
                    <View style={styles.checked_img}>
                      <Image source={AppImages.connected} style={styles.check_img} resizeMode="contain" />
                    </View>
