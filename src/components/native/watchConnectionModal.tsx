import { disconnectDevice, getBluetoothStatusOnOff, selectBleDevice, watchSdkEmitter } from '.';
  ...
  return (
    <Overlay visible={props.open} p={0}>
      <Div pt={20} px={10} justifyContent="center" alignItems="center" mb={60}>
        ...
        {!bluetoothOn ? <Text>Please turn on the Bluetooth on your phone</Text> : null}
      ...
      {bluetoothOn ? (
        <Div w="100%" flexDir="row" borderTopColor={baseColors.themeLight} borderTopWidth={1} position="absolute" bottom={0}>
          <Button w="100%" bg={baseColors.themeLight} color={baseColors.white} onPress={props.closeModal} rounded={0} roundedBottom={6}>
            Cancel
          </Button>
        </Div>
      ) : null}
